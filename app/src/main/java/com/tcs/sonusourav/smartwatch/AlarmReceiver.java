...
public class AlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        // Get notification title from ReminderActivity Database
        ReminderDatabase rb = new ReminderDatabase(context);
        Reminder reminder = rb.getReminder(mReceivedID);
        String mTitle = reminder.getTitle();

        // Create intent to open com.tcs.sonusourav.smartwatch.ReminderEditActivity on notification click
    ...
    public void setAlarm(Context context, Calendar calendar, int ID) {
        ...
        // Put ReminderActivity ID in Intent Extra
    ...
    public void cancelAlarm(Context context, int ID) {
        ...
        // Cancel Alarm using ReminderActivity ID
